...
const Login = () => {
    ...
    <div className="h-[100vh] md:p-10 flex flex-col justify-center items-center xs:px-4">
        ...
        <div className="text-center bg-[transparent] border-4 border-[#000000] p-10  rounded-xl md:w-[35%]">
            <h1 className="md:text-[2.5rem] xs:text-[2rem] text-black">Login</h1>
            <form action="#" className="flex flex-col gap-2 xs:mt-5 sm:mt-20 pb-5 border-b-2 border-black" onSubmit={formSubmit}>
                ...
                <div className="border-[#000000] border-[3px] rounded-md p-2 md:text-xl sm:text-base flex items-center">
                    ...
                    <div className="md:text-xl sm:text-base cursor-pointer" onClick={showPass}>
                        {eye}
                    </div>
                </div>
                <div>
            ...
            {/* others */}
            <p className="md:text-xl sm:text-base py-5">Don't have an account? <Link to={'/register'} className="underline text-blue-500">Register</Link></p>
            <button className="text-xl border-2 border-black p-2 bg-black hover:bg-white transition duration-[0.3s] rounded-lg text-white hover:text-black">
